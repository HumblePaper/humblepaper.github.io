        ...
        <div class="ui stackable very relaxed center aligned grid container">
          <div class="row">
            <div class="twelve wide column">
              ...
              <h1 class="ui header">Design Beautiful Websites Quicker</h1>
      ...
      <span class="tag">&lt;/<span class="title">select</span>&gt;</span></code></pre></div>
          ...
          <div class="row">
            <div class="seven wide column">
              ...
              <div class="ui info message">Don't have access to development tools right now? Check out <a href="http://t.co/GOUQx8iCyG">this short clip</a>.
              </div>
            </div>
            <div class="nine wide column">
