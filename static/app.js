(function (global, factory) {
	    ...
	    var parsers = function () {
	      ...
	      var _p = {
	        html: {
	          ...
	          pug: function pug(html, opts, url) {
	...
	var riot = riot_compiler && (typeof riot_compiler === 'undefined' ? 'undefined' : _typeof(riot_compiler)) === 'object' && 'default' in riot_compiler ? riot_compiler['default'] : riot_compiler;
	...
	*/
	 ...
	 */
	var _store = {
	  dispatch: function dispatch(actionName) {
	   ...
	   */
	  subscribe: function subscribe(component, states, handler) {
	   ...
	   */
	  unsubscribe: function unsubscribe(tag) {
	   ...
	   */
	  update: function update(actionName) {
	...
	var riot$1 = createCommonjsModule(function (module, exports) {
	/* Riot v2.4.1, @license MIT */
	...
	* @param   { Object } options - set the propery overriding the default options
	...
	var riot$2 = (riot$1 && typeof riot$1 === 'object' && 'default' in riot$1 ? riot$1['default'] : riot$1);

	riot$2.tag2('router', '', '', '', function (opts) {
		var self = this;
		...
		this.on('update', function () {
			...
			riot$2.route(self.route);
		});

		this.on('mount', function () {
			self.route = riotux.get('route');
			riot$2.route.base(self.route);
			riot$2.route.start(true);
		});
	...
	riot$2.tag2('app', '<h1>Hello World</h1> <router></router>', '', '', function (opts) {});

	riot$2.tag2('homepage', '<loggedin_homepage></loggedin_homepage> <anon_homepage></anon_homepage>', '', '', function (opts) {});

	riot$2.tag2('anon_homepage', '<login></login>', '', '', function (opts) {});

	riot$2.tag2('login', '<form class="ui form" id="signinForm" onsubmit="{this.loginUser}"> <h4 class="ui dividing header">Login</h4> <div> <div class="field"> <label>Username</label> <input type="text" name="username" placeholder="username"> </div> <div class="field"> <label>Password</label> <input type="password" name="password" placeholder="password"> </div> <button __disabled="{this.currentData.loading}" class="{loading: this.currentData.loading, ui: true, button: true}" type="submit" form="signinForm" value="Submit">SignIn</button> </div> </form>', '', '', function (opts) {
	  var self = this;
	});
